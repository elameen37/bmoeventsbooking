...
import { Calendar, Shield, Info, CheckCircle2, X } from "lucide-react";
...
export const AboutUsModal = ({ children }: ModalProps) => {
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[600px] glass-card border-primary/20 bg-background/95 backdrop-blur-xl p-0 overflow-hidden">
        <div className="p-6">
          <DialogHeader>
          ...
          <div className="max-h-[60vh] mt-6 overflow-y-auto pr-4 custom-scrollbar">
